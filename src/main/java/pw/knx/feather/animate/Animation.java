 ...
 * <p>
 * The voids in this interface return the pw.knx.feather.animate.Animation object for easy method chaining.
 *
 * @author KNOXDEV
...
public class Animation {
     ...
     *
     * @return the original pw.knx.feather.animate.Animation object
     */
    ...
    /**
     * @param transition the transition you wish to set your current pw.knx.feather.animate.Animation to
     * @return the original pw.knx.feather.animate.Animation object
     */
    ...
    /**
     * @param duration the duration you wish to set your pw.knx.feather.animate.Animation to
     * @return the original pw.knx.feather.animate.Animation object
     */
    ...
    /**
     * @return true, if the animation is currently forward
     */
    ...
    /**
     * Gives your current pw.knx.feather.animate.Animation progress on a scale from 0-1.0.
